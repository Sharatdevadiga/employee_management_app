...
export async function userLogin(req, res) {
  try {
    ...
    //1. IF name AND PASSWORD ARE NOT THER SEND ERROR
    if (!name || !password)
      return errorHandler(res, 404, "Please provide proper name and password");
    ...
    if (!user || !isPasswordCorrect)
      return errorHandler(res, 404, "Incorrect name/password.");
